...
urlpatterns += (
    path("payment/confirm-payment/", ConfirmSuccessfulPaymentView.as_view(), name="confirm-payment"),
    path("payment/get-invoice/", GetInvoiceView.as_view(), name="get-invoice"),
)
