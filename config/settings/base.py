...
# veryusefulproject/
APPS_DIR = BASE_DIR / "veryusefulproject"
env = environ.Env()
...
LOCAL_APPS = [
    "veryusefulproject.core",
    "veryusefulproject.users",
    "veryusefulproject.blogs",
    ...
    "veryusefulproject.request_marketplace",
    "veryusefulproject.shipping",
    "veryusefulproject.orders",
...
MIGRATION_MODULES = {"sites": "veryusefulproject.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "veryusefulproject.core.middlewares.CustomCsrfViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "veryusefulproject.users.middleware.PreventSuspendedUsersMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "veryusefulproject.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Soojong Wi""", "wi3733@naver.com")]
...
LOGGING = {
    ...
    "handlers": {
        "django.db.backends": {
            ...
            "filename": str(BASE_DIR / "logs" / "logs.log"),
            "formatter": "verbose"
        },
        "console": {
            "level": "DEBUG",
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "veryusefulproject.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "veryusefulproject.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
SPECTACULAR_SETTINGS = {
    "TITLE": "veryUsefulProject API",
    "DESCRIPTION": "Documentation of API endpoints of veryUsefulProject",
    "VERSION": "1.0.0",
